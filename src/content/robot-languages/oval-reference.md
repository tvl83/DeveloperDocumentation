...
| Name                                         | Description |
|----------------------------------------------|-------------|                                                                   
| backLed                                      | Brightness of back LED light <ul><li>Type: float</li><li>Access: W</li><li>Min Value: 0.0</li><li>Max Value: 255.0</li><li>Units: (no unit)</li></ul> |
| redLed                                       | Sets the value of the red component of the RGB LED <ul><li>Type: float</li><li>Access: W</li><li>Min Value: 0.0</li><li>Max Value: 255.0</li><li>Units: (no unit)</li></ul> |
| greenLed                                     | Sets the value of the green component of the RGB LED <ul><li>Type: float</li><li>Access: W</li><li>Min Value: 0.0</li><li>Max Value: 255.0</li><li>Units: (no unit)</li></ul> |
| blueLed                                      | Sets the value of the blue component of the RGB LED <ul><li>Type: float</li><li>Access: W</li><li>Min Value: 0.0</li><li>Max Value: 255.0</li><li>Units: (no unit)</li></ul> |
| leftMotorPwm                                 | Get or set the pwm of the left motor <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: -4095.0</li><li>Max Value: 4095.0</li><li>Units: (no unit)</li></ul> |
| rightMotorPwm                                | Get or set the pwm of the right motor <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: -4095.0</li><li>Max Value: 4095.0</li><li>Units: (no unit)</li></ul> |
| controlSystemIsOn                            | Returns 1 if the control system is on, 0 if it is not <ul><li>Type: int</li><li>Access: RW</li><li>Min Value: 0</li><li>Max Value: 1</li><li>Units: bool</li></ul> |
| controlSystemIsInverted                      | Drive upside down. (Ollie Only) <ul><li>Type: int</li><li>Access: RW</li><li>Min Value: 0</li><li>Max Value: 1</li><li>Units: bool</li></ul> |
| nextRandomInt                                | Get next pseudo-random int. Set random number seed <ul><li>Type: int</li><li>Access: RW</li><li>Min Value: -2^31</li><li>Max Value: 2^31-1</li><li>Units: (no unit)</li></ul> |
| nextRandomFloat                              | Get next pseudo-random float. Set random number seed <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: 0.0</li><li>Max Value: 1.0</li><li>Units: (no unit)</li></ul> |

## Sensor Properties
| Name                                         | Description |
|----------------------------------------------|-------------|
| locatorPositionX                             | X coordinate of current position on floor <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: meters</li></ul> |
| locatorPositionY                             | Y coordinate of current position on floor <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: meters</li></ul> |
| locatorVelocityX                             | Current X velocity <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: m/s</li></ul> |
| locatorVelocityY                             | Current Y velocity <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: m/s</li></ul> |
| imuPitchAngle                                | Gets the value of the pitch angle from the IMU <ul><li>Type: float</li><li>Access: R</li><li>Min Value: -180.0</li><li>Max Value: 180.0</li><li>Units: degrees</li></ul> |
| imuRollAngle                                 | Gets the value of the roll angle from the IMU <ul><li>Type: float</li><li>Access: R</li><li>Min Value: -90.0</li><li>Max Value: 90.0</li><li>Units: degrees</li></ul> |
| imuYawAngle                                  | Gets the value of the yaw angle from the IMU <ul><li>Type: float</li><li>Access: R</li><li>Min Value: -180.0</li><li>Max Value: 180.0</li><li>Units: degrees</li></ul> |
| gyroSensorPitch                              | Rotation rate around pitch axis <ul><li>Type: float</li><li>Access: R</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: deg/s</li></ul> |
| gyroSensorRoll                               | Rotation rate around roll axis <ul><li>Type: float</li><li>Access: R</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: deg/s</li></ul> |
| gyroSensorYaw                                | Rotation rate around yaw axis <ul><li>Type: float</li><li>Access: R</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: deg/s</li></ul> |
| wheelSlipRate                                | Estimate of how much wheels are slipping <ul><li>Type: float</li><li>Access: R</li><li>Min Value: 0.0</li><li>Max Value: any</li><li>Units: (no unit)</li></ul> |
| lastCollisionTime                            | Time of last collision (see OnCollision and currentRobotTime) <ul><li>Type: float</li><li>Access: R</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: seconds</li></ul> |
| accelSensorXRight                            | Accelerometer reading on X axis <ul><li>Type: float</li><li>Access: R</li><li>Min Value: -8.0</li><li>Max Value: 8.0</li><li>Units: Gs</li></ul> |
| accelSensorYForward                          | Accelerometer reading on Y axis <ul><li>Type: float</li><li>Access: R</li><li>Min Value: -8.0</li><li>Max Value: 8.0</li><li>Units: Gs</li></ul> |
| accelSensorZUp                               | Accelerometer reading on Z axis <ul><li>Type: float</li><li>Access: R</li><li>Min Value: -8.0</li><li>Max Value: 8.0</li><li>Units: Gs</li></ul> |
| verticalAcceleration                         | Gets the current vertical acceleration. <ul><li>Type: float</li><li>Access: R</li><li>Min Value: -8.0</li><li>Max Value: 8.0</li><li>Units: Gs</li></ul><br /> **Note: Should be ~1G when stationary.** |
| freeFallMaxG                                 | Total acceleration must be less than this to count as free fall (see OnFreeFall) <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: Gs</li></ul><br />**Note: It is possible to set a max value higher than can be read by the hardware. Ensure that the set value is realistic and falls within accelerometer ranges.**|
| freeFallMinDuration                          | Total acceleration must be small for at least this time to count as free fall (see OnFreeFall). <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: seconds</li></ul><br />**Note: If you send a negative value, the value will be interpreted as an unsigned integer and saved.**|
| landingMinG                                  | More total acceleration than this counts as landing (see OnLanding) <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: -8.0</li><li>Max Value: 8.0</li><li>Units: Gs</li></ul> |

## Advanced Control System Properties
| Name                                          | Description |
|-----------------------------------------------|-------------|                                                                   
| controlSystemTargetImuYaw                     | Target yaw for control system in same coordinate system as imuYawAngle. controlSystemTargetImuYaw = imuYawAngle does not rotate the robot. <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: -180.0</li><li>Max Value: 180.0</li><li>Units: degrees</li></ul> |
| supercontrollerTargetPitchOverride            | Desired pitch angle in lieu of speed controller (see shouldOverrideSupercontrollerTargetPitch) <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: degrees</li></ul> |
| shouldOverrideSupercontrollerTargetPitch      | When true disable speed controller and use supercontrollerPitchOverride as target pitch <ul><li>Type: int</li><li>Access: RW</li><li>Min Value: 0</li><li>Max Value: 1</li><li>Units: bool</li></ul> |
| controlSystemTargetYaw                        | Get or set the target yaw for the control system. This will have no effect if the control system is off <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: degrees</li></ul><br />**Note: in a different coordinate system than imuYawAngle (see controlSystemTargetImuYaw).** |
| controlSystemTargetSpeed                      | Get or set the target speed for the control system. This will have no effect if the control system is off <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: -255.0</li><li>Max Value: 255.0</li><li>Units: (no unit)</li></ul><br />**Note: It is possible to send a speed that is not achievable by the robot.** |
| currentRobotTime                              | Get or set the robot time <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: seconds</li></ul><br /><br />**Note: If you send a negative value, the value will be interpreted as an unsigned integer and saved.** |
| controlSystemPitchPGain                       | Proportional gain of pitch controller <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemPitchIGain                       | Integral gain of pitch controller <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemPitchDGain                       | Derivative gain of pitch controller <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemYawPGain                         | Proportional gain of yaw controller <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** | 
| controlSystemYawIGain                         | Integral gain of yaw controller <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemYawDGain                         | Derivative gain of yaw controller <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemTorqueMinSensitiveRegion         | Internal control system parameter <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemTorqueMaxSensitiveRegion         | Internal control system parameter <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: (no unit)</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemMinRotationRate                  | The minimum rotation rate that the control system is able to use <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: deg/s</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemMaxRotationRate                  | The maximum rotation rate that the control system is able to use <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: deg/s</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
| controlSystemMaxYawErrorWhileDrivingFullSpeed | <ul><li>Type: float</li><li>Access: RW</li><li>Min Value: any</li><li>Max Value: any</li><li>Units: degrees</li></ul><br /><br />**WARNING: Changing this value can break the way your robot to drives. Ensure that you back up the value before changing it.** |
...
| void saveCodeLibrary(int stashId)																							| Saves the current library to the location in flash specified by the stash id.                                                                                  |
